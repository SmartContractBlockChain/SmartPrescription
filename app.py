...
"""
    ...
    @app.route("/prescription/<string:tx_hash>")
    def get_prescription(tx_hash):
...
"""
    ...
    @app.route("/prescriber/<string:tx_hash>")
    def get_prescriber(tx_hash):
        address = w3.eth.getTransactionReceipt(tx_hash)["contractAddress"]
        creator = (
...
"""
    ...
    @app.route("/redeem/<string:tx_hash>", methods=["POST"])
    def redeem_prescription(tx_hash):
        address = w3.eth.getTransactionReceipt(tx_hash)["contractAddress"]
